...
const DeleteIcon = (props: ComponentProps<'svg'>) => (
  <svg
    ...
    {...props}
  >
    <path d="M13.5 3.5H2.5" stroke="#BB251A" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M6.5 6.5V10.5" stroke="#BB251A" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M9.5 6.5V10.5" stroke="#BB251A" strokeLinecap="round" strokeLinejoin="round" />
    <path
