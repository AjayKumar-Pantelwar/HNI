...
const DeleteFileIcon = (props: ComponentProps<'svg'>) => (
  <svg
    width="16"
    height="16"
    viewBox="0 0 16 16"
    ...
    {...props}
  >
    <path d="M13.5 3.5H2.5" stroke="#1B1C1E" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M6.5 6.5V10.5" stroke="#1B1C1E" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M9.5 6.5V10.5" stroke="#1B1C1E" strokeLinecap="round" strokeLinejoin="round" />
    <path
