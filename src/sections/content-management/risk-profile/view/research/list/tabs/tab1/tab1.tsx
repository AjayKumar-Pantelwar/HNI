...
import { ResearchData, SubTabs } from 'src/types/content-management/research.types';
...
const ResearchTab1 = (props: Props) => {
  ...
  const [tab, setTab] = useState<SubTabs>(SubTabs.ELEMENT);
  ...
  const handleChange = (_event: React.SyntheticEvent, newValue: SubTabs) => {
    setTab(newValue);
  };
