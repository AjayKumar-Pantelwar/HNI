...
const BondAMCEditDailog = (props: Props) => {
  const { currentAMC, open, onClose, bond_id } = props;
  const router = useRouter();

  const [logo, setLogo] = React.useState<File>();

  const [editAMC] = bondsApi.useEditAMCMutation();
...
export default BondAMCEditDailog;
